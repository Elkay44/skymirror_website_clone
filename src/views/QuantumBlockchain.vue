        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto items-center">
          ...
          <div class="flex items-center justify-center">
            <div class="relative w-full max-w-sm">
              <div class="aspect-square rounded-lg bg-gradient-to-br from-primary/10 to-accent2/10 p-4 shadow-lg">
                <div class="relative w-full h-full border-2 border-dashed border-primary/30 rounded-md flex items-center justify-center">
                  <svg class="w-24 h-24 text-primary opacity-50" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    ...
    <section class="py-20 bg-neutral-50">
      <div class="container mx-auto px-4">
        <div class="text-center max-w-3xl mx-auto mb-16">
          <h2 class="text-3xl font-heading font-bold mb-4">Industries We Serve</h2>
          <p class="text-gray-700">
            Our technology transfer services span across multiple industries, enabling businesses to expand and innovate.
          </p>
        </div>
