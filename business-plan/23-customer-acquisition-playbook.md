...
AWARENESS          CONSIDERATION         DECISION           ONBOARDING         EXPANSION
    ...
    ▼                    ▼                   ▼                   ▼                  ▼
┌─────────┐        ┌──────────┐        ┌──────────┐        ┌──────────┐      ┌──────────┐
│ Problem │        │ Research │        │ Evaluate │        │ Implement│      │ Expand   │
│ Aware   │───────▶│ Solutions│───────▶│ Options  │───────▶│ & Adopt  │─────▶│ & Refer  │
└─────────┘        └──────────┘        └──────────┘        └──────────┘      └──────────┘
    │                    │                   │                   │                  │
    ▼                    ▼                   ▼                   ▼                  ▼
...
|---------|------------|-----------------|--------|----------|
| Outbound Sales | €8,000 | 5% | Medium | HIGH |
| Inbound Marketing | €5,000 | 8% | Low-Medium | HIGH |
| Partner Referrals | €3,000 | 15% | Low | MEDIUM |
| Events/Conferences | €10,000 | 3% | Low | MEDIUM |
| Customer Referrals | €1,500 | 25% | Low | HIGH |
...
|-----|----------|---------|----------|
| 1 | Initial outreach | Email | Cold Email #1 |
| 3 | Follow-up | LinkedIn | Connection request |
| 5 | Value-add | Email | Cold Email #2 (case study) |
| 8 | Phone call | Phone | Cold call script |
| 12 | Break-up email | Email | Cold Email #3 |
| 15 | LinkedIn engagement | LinkedIn | Comment/share |
| 20 | Final attempt | Email | Cold Email #4 |
...
TOFU (Awareness)           MOFU (Consideration)        BOFU (Decision)
      ...
      ▼                           ▼                          ▼
┌─────────────┐            ┌─────────────┐            ┌─────────────┐
│ Blog Posts  │            │ Webinars    │            │ Free Trial  │
│ Social Media│───────────▶│ Whitepapers │───────────▶│ Demo        │
│ SEO Content │            │ Case Studies│            │ Proposal    │
└─────────────┘            └─────────────┘            └─────────────┘
      │                           │                          │
...
|----------|-----------|--------------|
| **Budget** | What's your budget for this initiative? Have you allocated funds? | €10K+ annual budget available |
...
|-------|-------------|-------------|
| Visitor → Lead | 2% | Leads / Visitors |
| Lead → MQL | 50% | MQLs / Leads |
| MQL → SQL | 40% | SQLs / MQLs |
| SQL → Opportunity | 50% | Opportunities / SQLs |
| Opportunity → Closed | 20% | Closed Won / Opportunities |
...
|--------|------------|--------|-------------|
| **CAC** | Customer Acquisition Cost | €8,000 | S&M Spend / New Customers |
| **LTV** | Lifetime Value | €24,000 | ARPU × Gross Margin × Lifespan |
| **LTV:CAC** | Ratio | 3:1 | LTV / CAC |
| **Payback** | Months to recover CAC | 12 months | CAC / (ARPU × Gross Margin) |
| **ARPU** | Avg Revenue Per User | €800/mo | MRR / Customers |
...
|--------|--------|--------|--------|
| Active Users | X | X | 🟢/🟡/🔴 |
| Recognition Accuracy | 99% | X% | 🟢/🟡/🔴 |
| Admin Time Saved | X hrs/wk | X hrs/wk | 🟢/🟡/🔴 |
| Support Tickets | <X | X | 🟢/🟡/🔴 |
...
|--------|-----------|--------|
| Usage drop | >20% decline | Reach out within 48 hours |
| Support spike | >3x normal tickets | Escalate to CS manager |
